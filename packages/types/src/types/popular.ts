...
export const popular = S.Struct({
  ...
  /**
   * The type of trending recommendation to use - ie to return items that are trending in the latest
   * 1 day period
   *
   * Available values:
   *
...
export type popular = S.Schema.Type<typeof popular>
export const popularEncoded = S.encodedSchema(popular)
export type popularEncoded = S.Schema.Encoded<typeof popular>
