...
export interface FarcasterFeedCardRenderProps {
  item: FeedItem
}

export interface FarcasterFeedCardProps {
  item: FeedItem
  onReply?: (() => void) | undefined
  onShare?: (() => void) | undefined
  onTip?: (() => void) | undefined
  onViewProfile?: (() => void) | undefined
  render?: (args: FarcasterFeedCardRenderProps) => ReactNode
}

export function FarcasterFeedCard({
  item,
  onReply,
  onShare,
  onTip,
